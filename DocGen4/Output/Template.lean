  ...
  pure
    <html lang="en">
      ...
      <body>
                  ...
                  <div class="ml-auto flex items-center gap-2 sm:gap-4 mr-2 sm:mr-4">
                    <button id="copy-page-btn" class="flex items-center justify-center w-8 h-8 flex-shrink-0 rounded-sm text-[var(--muted-text-color)] hover:text-[var(--text-color)] border border-[var(--border-color)] bg-[var(--panel-bg)] hover:bg-[var(--code-bg)] transition-colors focus:outline-none" title="Copy page to clipboard">
                      {.raw "<svg class=\"w-4 h-4\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"9\" y=\"9\" width=\"13\" height=\"13\" rx=\"2\" ry=\"2\"></rect><path d=\"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1\"></path></svg>"}
                    </button>
                    <button id="theme-toggle" class="flex items-center justify-center w-8 h-8 flex-shrink-0 rounded-sm text-[var(--muted-text-color)] hover:text-[var(--text-color)] border border-[var(--border-color)] bg-[var(--panel-bg)] hover:bg-[var(--code-bg)] transition-colors focus:outline-none" title="Toggle dark mode (⌘T)">
